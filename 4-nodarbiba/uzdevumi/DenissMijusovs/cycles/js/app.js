...
const boxList = ["Box 1", "Box 2", "Box 3", "Box 4", "Box 5", "Box 6"];

const appendListElements = () => {
  //clear HTML elements
  listContainer.innerHTML = "";
  //function for each element to display box list
  boxList.forEach((item, i) => {
    const listItem = `<div class="list-item" style="background-color: ${backgroundColors[i]}">${item}</div>`;
